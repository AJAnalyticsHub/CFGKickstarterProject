...
cardoccasion_id INT NOT NULL AUTO_INCREMENT, occasion VARCHAR(50) NOT NULL, cardsentiment_id VARCHAR(50),
...
CONSTRAINT pk_customer_id PRIMARY KEY (cusomter_id));    
...
CREATE TABLE Sales (
    ...
    CONSTRAINT fk_adtarget_id FOREIGN KEY (adtarget_id) REFERENCES ADTarget(adtarget_id));